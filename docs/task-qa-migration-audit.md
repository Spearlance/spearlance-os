...
Scope: Viktor's "QA migration audit" brief. Nothing was applied: every migration was
dry-run on the **dev** project inside `BEGIN … ROLLBACK` and the schema was verified
unchanged afterwards. Production was not touched or queried.
