...
import { Users, Building2, BarChart3, Loader2, Globe, KeyRound, Mail, FileText, Settings, Briefcase } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-end gap-2 mb-4">
        <Button onClick={() => navigate("/admin/designer-workload")} variant="outline">
