...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/armadillo
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/armadillo-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using armadillo:subagent-driven-development. The plan is at: $PLAN_PATH"
