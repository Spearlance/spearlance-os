...
mkdir -p src test .claude/docs/plans

# Create a simple implementation plan
cat > .claude/docs/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at .claude/docs/plans/implementation-plan.md using the subagent-driven-development skill.
...
# IMPORTANT: Run from armadillo directory so local dev skills are available
PROMPT="Change to directory $TEST_PROJECT and then execute the implementation plan at .claude/docs/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"armadillo:subagent-driven-development"' "$SESSION_FILE"; then
