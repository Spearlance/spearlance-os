...
matching row from `supabase_migrations.schema_migrations`.
...
| `gated/20260902120001_tasks_qa_state_alt.sql` | `20260902120001_tasks_qa_state_alt.down.sql` |
| `gated/20260902120000_task_status_add_values.sql` | **none, see below** |

## Why there is no down for the enum change
